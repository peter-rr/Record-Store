...
const orderserviceNewOrder = require('./routes/orderservice-new-order.js');
...
// Channels
console.log(cyan.bold.inverse(' SUB '), gray('Subscribed to'), yellow('orderservice/new/order'));
app.use(orderserviceNewOrder);
